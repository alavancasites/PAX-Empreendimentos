...
class EmpCategoriaController extends GxController {


    public function getRepresentingFields(){
		return EmpCategoria::representingColumn();
	}

	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'EmpCategoria'),
		));
	}

	public function actionCreate() {
		$model = new EmpCategoria;

		if (isset($_POST['EmpCategoria'])) {
			$model->setAttributes($_POST['EmpCategoria']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idemp_categoria,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['EmpCategoria'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idemp_categoria,'success'=>'update')));
			}
		}
	...
	{
		$model=EmpCategoria::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'idemp_categoria desc';
        }
		...
		$dataProvider = new CActiveDataProvider('EmpCategoria', array(
            'criteria'=>$criteria,
			'pagination' => array(
