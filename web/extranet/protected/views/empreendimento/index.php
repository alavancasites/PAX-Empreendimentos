          ...
          <thead>
            <tr>
              ...
              foreach ( $this->getRepresentingFields() as $field ) {
                ...
                ?>
              <th> <a class="btn-link" href="<?php echo $this->createUrlRel('index',array_merge($_GET,array('f'=>$field,'o'=>$ordem)));?>"> <i class="fa <?=$icon;?>"></i>
                <?=htmlentities($model->getAttributeLabel($field));?>
                </a> </th>
              <?
              }
              ?>
