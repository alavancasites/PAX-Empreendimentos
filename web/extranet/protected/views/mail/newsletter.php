...
<title>E-mail cadastrado no site</title>
  ...
  <div style="width:750px; margin-left:auto; margin-right:auto;">
    <div>
      ...
      <div style="margin-top:30px">
        <h1 style="color: #555; font-size:16px; text-align:center; display:block">E-mail cadastrado no site</h1>
        <div style="margin-top:20px; padding:20px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="4">
            <tr class="fundo">
              <td width="23%"><strong>E-mail:</strong></td>
              <td width="77%"><?=htmlentities($newsletter->email);?></td>
            </tr>
          </table>
        </div>
      </div>
