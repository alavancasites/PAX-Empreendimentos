 ...
 * @property Empreendimento[] $empreendimentos1
 */
abstract class BaseGallery extends GxActiveRecord {
	...
	public function relations() {
		return array(
			'empreendimentos' => array(self::HAS_MANY, 'Empreendimento', 'gallery_id'),
			'empreendimentos1' => array(self::HAS_MANY, 'Empreendimento', 'gallery_id1'),
		);
	}
