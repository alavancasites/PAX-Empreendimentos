  ...
  <section class="novidades">
    ...
    <div class="container mt-5">
      <div class="colunas col-7">
        <h2 class="title2">
          <strong>
            Valorização do mercado imobiliário em até 40%
          </strong>
        </h2>
      </div>
      <div class="colunas col-5">
        <img src="img/novidade.png" class="img-responsive" alt="  Valorização do mercado imobiliário em até 40%">
      </div>
      ...
      <div class="clear"></div>
      <div class="colunas col-10 mt-5">
        <img src="img/novidade1.png" class="img-responsive" alt="Valorização do mercado imobiliário em até 40%">
      </div>
      <div class="colunas col-10 texto mt-5">
        <h2 class="mb-3">
          <strong>
